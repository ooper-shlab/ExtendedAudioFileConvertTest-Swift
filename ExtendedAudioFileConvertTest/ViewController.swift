...
@objc(ViewController)
class ViewController: UIViewController, ExtendedAudioFileConvertOperationDelegate, AVAudioPlayerDelegate {
    ...
    private var operation: ExtendedAudioFileConvertOperation?
    ...
    @IBAction func userDidPressConvertAndPlayButton(_ sender: UIButton) {
        ...
        self.outputFormatSelector.isEnabled = false
        self.outputSampleRateSelector.isEnabled = false
        
        self.operation = ExtendedAudioFileConvertOperation(sourceURL: self.sourceURL, destinationURL: self.destinationURL, sampleRate: self.sampleRate, outputFormat: self.outputFormat)
    ...
    func audioPlayerDidFinishPlaying(_ player: AVAudioPlayer, successfully flag: Bool) {
        self.convertAndPlayButton.setTitle("Convert & Play File", for: .normal)
        self.convertAndPlayButton.isEnabled = true
        self.outputFormatSelector.isEnabled = true
        self.outputSampleRateSelector.isEnabled = true
